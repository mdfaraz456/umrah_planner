...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result !== false) {
        $_SESSION['msg'] = ($submissionType === 'Submit') ? 'Advertisement added successfully.' : 'Advertisement updated successfully.';
...
$advertisements = $advertisementObj->getAllAdvertisements('Advertisement');
?>
                                    ...
                                    <?php foreach ($advertisements as $index => $advertisement): ?>
                                        <tr>
                                            ...
                                            <td class="icon-dlt-edit">
                                                ...
                                                <?php endif; ?>
                                                <a href="advertisement.php?id=<?php echo base64_encode($advertisement['id']) ?>" title="Edit">

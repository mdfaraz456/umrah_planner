...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result !== false) {
        ...
        header("Location: all-heading.php");
        exit;
    } else {
...
// Get all headings
$headings = $headingObj->getAllContent('heading');
?>
...
<head>
    ...
    <title>Admin | Heading Management</title>
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Heading Management</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Heading Management</li>
                        </ol>
                    </div>
                    <div class="col-md-7 align-self-center text-right d-none d-md-block">
                        <a href="heading.php"><button type="button" class="btn btn-info">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <form method="POST" id="headingForm">
                                                ...
                                                <input type="hidden" name="brandType" value='heading'>
                                                <div class="row">
                                                    <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            <td class="icon-dlt-edit">
                                                <?php if ($heading['status'] == 1): ?>
                                                    <a href="?id=<?php echo $heading['id']; ?>&status=0" title="Hide">
                                                        <i class="fa-solid fa-eye" style="color: #e41111;"></i>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="?id=<?php echo $heading['id']; ?>&status=1" title="Show">
                                                        <i class="fa-solid fa-eye-slash" style="color: #d21414;"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <a href="all-heading.php?id=<?php echo base64_encode($heading['id']); ?>" title="Edit">
    ...
    <script>
        $(document).ready(function() {
            console.log('Heading Form Ready');
            ...
            $("#headingForm").validate({
                ...
                submitHandler: function(form) {
                    console.log('Heading form valid, submitting...');
                    form.submit();
                }
            });

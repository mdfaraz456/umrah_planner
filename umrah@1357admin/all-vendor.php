...
$userData = $userObj->getAllUser('Vendor');
$db = new dbClass();
      ...
      <div class="container-fluid">
        ...
        <div class="row page-titles">
          ...
          <div class="col-md-7 align-self-center text-right d-none d-md-block">
            <a href="vendor.php"><button type="button" class="btn btn-info">
                      ...
                      foreach ($userData as $users): ?>
                        <tr>
                          ...
                          <td class="icon-dlt-edit ">
                            ...
                            <a href="vendor.php?id=<?php echo base64_encode($users['user_id'] ?? '') ?>"><i class="fa-solid fa-pencil" style="color: #e81111;"></i></a>

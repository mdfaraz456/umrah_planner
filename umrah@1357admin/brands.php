...
if (!empty($editId)) {
    $editData = $brandObj->getBrandById($editId);
}
...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
    ...
    if ($id > 0) {
        ...
        if ($sqlDelete) {
            ...
            $_SESSION['errmsg'] = 'Failed to delete brand!';
        }
    } else {
...
// Get all brands
$brands = $brandObj->getAllBrands('Brands');
?>
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">
                            <?php echo $editId ? 'Update Brand' : 'Add Brand' ?>
                        </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active"><?php echo $editId ? 'Update Brand' : 'Add Brand' ?></li>
                        </ol>
                    </div>
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body"> 
                                ...
                                <form method="POST" id="brandForm" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="brandType" value="Brands">
                                    <div class="row">
                                        <div class="col-6">
                                    ...
                                    <?php foreach ($brands as $index => $brand): ?>
                                        <tr>
                                            ...
                                            <td class="icon-dlt-edit">
                                                ...
                                                <?php endif; ?>
                                                <a href="brands.php?id=<?php echo base64_encode($brand['brands_id']) ?>" title="Edit">

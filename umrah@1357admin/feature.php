...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $status = $_POST['status'] ?? '';
    $brandType = $db->addStr($_POST['Type'] ?? '');
...
// Get all brands
$brands = $brandObj->getAllBrands('Feature');
?>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Feature</h3>
                        <ol class="breadcrumb">
                                    ...
                                    <?php foreach ($brands as $index => $brand): ?>
                                        <tr>
                                            ...
                                            <td class="icon-dlt-edit">
                                                ...
                                                <?php endif; ?>
                                                <a href="feature.php?id=<?php echo base64_encode($brand['brands_id']) ?>" title="Edit">

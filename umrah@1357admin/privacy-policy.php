...
$privacyPolicies = $privacyObj->getAllPolicies('privacy');
?>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">
                            <?php echo $editId ? 'Update Privacy Policy' : 'Add Privacy Policy' ?>
                        </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active"><?php echo $editId ? 'Update Privacy Policy' : 'Add Privacy Policy' ?></li>
                        </ol>
                    </div>
                    <div>
                            ...
                            <div class="card">
                                <div class="card-body"> 
                                    ...
                                    <form method="POST" id="privacyForm" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="policyType" value="privacy">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Privacy Policies</h4>
                                        ...
                                        <?php foreach ($privacyPolicies as $index => $policy): ?>
                                            <tr>
                                                ...
                                                <td class="icon-dlt-edit">
                                                    ...
                                                    <?php endif; ?>
                                                    <a href="privacy-policy.php?id=<?php echo base64_encode($policy['privacy_id']) ?>" title="Edit">

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($privacyContent)) {
        ...
        if ($result !== false) {
            ...
            header("Location: term-and-condition.php");
            exit;
        } else {
...
$privacyPolicies = $privacyObj->getAllPolicies('T-Condition');
?>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">
                            <?php echo $editId ? 'Update Term and Condition' : 'Add Term and Condition' ?>
                        </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active"><?php echo $editId ? 'Update Term and Condition' : 'Add Term and Condition' ?></li>
                        </ol>
                    </div>
                    <div>
                            ...
                            <div class="card">
                                <div class="card-body"> 
                                    <form method="POST" id="privacyForm" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="policyType" value="T-Condition">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Term and Condition</h4>
                                        ...
                                        <?php foreach ($privacyPolicies as $index => $policy): ?>
                                            <tr>
                                                ...
                                                <td class="icon-dlt-edit">
                                                    ...
                                                    <?php endif; ?>
                                                    <a href="term-and-condition.php?id=<?php echo base64_encode($policy['privacy_id']) ?>" title="Edit">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#privacyForm").validate({
                ...
                messages: {
                    privacy: {
                        required: "Please enter the Term and Condition content."
                    },
                    status: {

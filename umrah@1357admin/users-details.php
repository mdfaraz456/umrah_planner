                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="heading-deatils">
                                    ...
                                    <a href="edit-new-user.html"><i class="fa-solid fa-pen-to-square" style="color: #f41010;"></i></a>
                                </div>
                                    ...
                                    <div class="col-12"> 
                                        <div class="details-flex mt-3">
                                            <div class="detail-item">
                                                <p class="key">Full Name (as on passport)</p>
                                                <p class="value">dummy</p>
                                            </div>
                                            <div class="detail-item">
                                        ...
                                        <div class="branch mt-3">
                                            <div class="detail-item">
                                                <p class="key">Marital Status</p>
                                                <p class="value">dummy</p>
                                            </div>
                                            <div class="detail-item">
                                                <p class="key">Passport Photo (First Page)</p>
                                                <p class="value">dummy</p>
                                            </div> 
                                            <div class="detail-item"> 
                                                <p class="key">Passport Photo (Second Page)</p>
                                                <p class="value">dummy</p>
                                            </div>
                                        </div> 
                                        <div class="branch mt-3">
                                            <div class="detail-item">
                                                <p class="key">Passport Size Photo</p>
                                                <p class="value">dummy</p>
                                            </div>
                                            <div class="detail-item"> 
                                            </div> 
